...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      setAuthErr(result.message || "Identifiants incorrects. Veuillez réessayer.");
    }
    // ────────────────────────────
        ...
        <div className="form-card">
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="form-group">
              <label className="form-label" htmlFor="login-email">Adresse Gmail</label>
